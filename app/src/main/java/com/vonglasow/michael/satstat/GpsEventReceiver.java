...
public class GpsEventReceiver extends BroadcastReceiver {
	...
	private static class AgpsUpdateTask extends AsyncTask<Object, Void, Integer> {
		...
		protected Integer doInBackground(Object... args) {
			...
			Log.i("Yigong", "Enter bug loop, the freq is " + freq + "\n");
			...
			//	Log.i(GpsEventReceiver.class.getSimpleName(), String.format("Next update due %1$tY-%1$tm-%1$td %1$tH:%1$tM:%1$tS (after %2$d ms)", next, freq));
			}
